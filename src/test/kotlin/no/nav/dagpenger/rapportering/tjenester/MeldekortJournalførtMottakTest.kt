...
class MeldekortJournalførtMottakTest {
    ...
    @BeforeEach
    fun setup() {
        MeldekortJournalførtMottak(testRapid, mockJournalfoeringRepository, mockKallLoggRepository)
    }

    @Test
    fun `Vi tar imot og håndterer meldekort journalført hendelser`() {
        ...
        jsonNode["JournalføreMeldekort"].asString() shouldBe "SE TILSVARENDE REQUEST"
    }
}
